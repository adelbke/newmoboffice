      ...
      >
        ...
        <div class="flex flex-row justify-end m-4">
          <button
            v-if="$store.getters['cart/totalItemsCount'] > 0"
            @click="order"
            class="self-center large-button mt-2"
          >
            Lancez la Commande
          </button>
        </div>
      ...
      >
        ...
        <div class="flex mb-2 flex-row flex-wrap md:flex-nowrap items-center">
          ...
          <div class="min-w-max border-l border-gray-700 p-2">
            ...
            <login-form
              v-if="!$strapi.user"
              v-on:logged-in="connected"
            ></login-form>
            <div v-else>
              Maintenant que vous êtes connectés, pouvez-vous confirmer vôtre
              numéro de téléphone
              <div class="mb-4">
                <label
                  class="block text-gray-700 text-sm font-bold mb-2"
        ...
        <button class="self-end large-button" @click="order">
