...
enctype="multipart/form-data" method="post">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="reference" id="input-reference" placeholder="{{ __('Référence') }}" value="{{old('reference')}}" class="form-control @error('reference') is-invalid @enderror text-dark form-control-alternative">
