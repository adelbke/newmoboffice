                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('products.update',$product) }}" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="pl-lg-4">
                            ...
                            <category-form hasError="{{$errors->has('category')}}" adminid="{{auth()->user()->admin->id}}" errormessage="{{$errors->first('category')}}" oldcategory="{{old('category')}}" oldtype="{{$product->type}}"></category-form>
                            ...
                            <div class="form-group @error('note') has-danger @enderror">
                                ...
                                <input type="text" name="note" id="input-note" value="{{old('note')}}" class="form-control form-control-alternative text-dark @error('note') is-invalid @enderror" placeholder="{{ __('Note') }}" value="{{ old('note') ?? $product->note }}" r autofocus>
