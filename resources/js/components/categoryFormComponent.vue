<template>
  <div>
    <div v-if="!haserror" class="form-group">
      ...
      <select
        v-model="selected"
        class="form-control text-dark form-control-alternative"
        id="category"
        name="category"
        @change="addTypes()"
      >
        ...
        <option
          value="Bibliotheque Mobilier ecoles creches"
        >Bibliothèque & Mobilier pour écoles et crèches</option>
    ...
    <div v-else class="form-group has-danger">
      ...
      <select
        v-model="selected"
        class="is-invalid text-dark form-control form-control-alternative"
        id="category"
        name="category"
        @change="addTypes()"
      >
    ...
    <div class="form-group">
      ...
      <select
        ...
        name="Type"
        id="Type"
        class="form-control-alternative text-dark form-control"
      >
        <option
          class="text-dark"
          v-for="item in category[selected]"
...
export default {
  mounted() {
    let vm = this;
    vm.selected = vm.oldcategory.Category;
    vm.category[vm.selected].push(vm.oldcategory);
    vm.subCategory = vm.oldcategory.id;
  },
  props: {
    errormessage: String,
    haserror: String,
